...
### Linux:
1. Go to [run-on-linux.sh](https://raw.githubusercontent.com/julfy/easy-ddos/0.1.0/run-on-linux.sh)
...
### Windows:
1. Download [run-on-windows.bat](https://raw.githubusercontent.com/julfy/easy-ddos/0.1.0/run-on-windows.bat)
2. Right click on text and select `Save as`
