...
def add_useragent():
	random_chrome = f'Chrome/{randint(90, 99)}.0.{randint(100, 4600)}.{randint(1, 200)}'
	uagents = []
	uagents.append(f'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) {random_chrome}  Safari/537.36')
	uagents.append(f'(Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) {random_chrome} Safari/537.36')
	...
	uagents.append(f'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) {random_chrome} Safari/537.36 Mozilla/5.0 (iPad; U; CPU OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Version/4.0.4 Mobile/7B334b Safari/531.21.10')
